...
{
    ui->setupUi(this);
    //In this part you inherit the properties of the method to a variable that will be used to show the method integra = new Integracion();
    ...
    //Connecting the buttons to show the methods
...
//Functions where each method is shown and can perform its operations
...
//Function to close all the windows of the integrated methods
